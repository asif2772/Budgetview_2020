...
//    def barBGColor = ['rgba(120,120,120,1)','rgba(255,0,0,.9)','rgba(255,0,0,.9)']
...
<% for (int v = 0; v < 3; v++) {
    if(v == 0){
        ...
        monthlyBookingAmount = netProfitForecastInstance;
    }else if(v == 1) {
...
%{--<div class="footerAmountSummary">--}%
    %{--<div class="labelOfBudgetInvoice">--}%
        %{--<div class="monthAmountLabel">BUDGET:</div>--}%
        %{--<div class="monthAmountLabel" style="margin-top: 18px;">FORECAST:</div>--}%
        %{--<div class="monthAmountLabel" style="margin-top: 18px;">INCOME:</div>--}%
        %{--<div class="monthAmountLabel" style="margin-top: 16px;">EXPENSE:</div>--}%
        %{--<div class="monthAmountLabel" style="margin-top: 16px;">Tax Reservation:</div>--}%
        %{--<div class="monthAmountLabel" style="margin-top: 15px;">Net Profit:</div>--}%
    %{--</div>--}%
%{--<% }else{ %>--}%
