...
<g:javascript src="jquery.highchartTable.js" />
...
<div id="income" style="padding: 0px; border-radius:none;height:400px">
    <div id="containerHC" style="min-width: 150px; height: 200px; margin: 0 auto"></div>
...
<script>
    $(function () {
        $('#containerHC').highcharts({
            ...
            series: [{
                name: 'Income',
                data: [50, 30, 40, 70, 20,50, 30, 40, 70, 20,70, 20]
            }, {
                name: 'Expense',
                data: [-20 -20, -30, -20,-10,-20, -20, -30, -20,-100, -20,-100]
            }, {
                name: 'Forcast',
                data: [30, 40, 40, 20, 50,30, 40, 40, 20, 50,20, 50]
            }],
            pointPadding: 0.3,
            groupPadding: 0.1,
            pointPlacement: -0.2
...
<div class="headerDashboard">
    <div class="headerLeft">
        <div >
            <a title="Budget" href="javascript:loadintoIframe('ifrmInc', '${urlCustomerWise}')"
               class="tooltip categoryBtnDb">Budget</a>
        </div>

        <div >
            <a id="awi" title="Booked Invoice" href="javascript:loadintoIframe('ifrmInc', '${urlAccHeadWise}')"
               class="tooltip categoryBtnDb">Booked Invoice</a>
        </div>

        <div >
            <a id="swi" title="Forecast"
               href="javascript:loadintoIframe('ifrmInc', '${urlSummeryWise}')" class="tooltip categoryBtnDb"><g:message code="bv.dashboardDetails.forecast.label" default="Forecast" /></a>
...
<div class="labelOfBudgetInvoice">
    <div class="monthAmountLabel">Income :</div>
    <div class="monthAmountLabel" style="margin-top: 18px;">Expense :</div>
    <div class="monthAmountLabel">Tax Reservation :</div>
    <div class="monthAmountLabel" style="margin-top: 18px;">Net Profit :</div>
    <div class="monthAmountLabel" style="margin-top: 18px;">VAT Indication :</div>
</div>
...
<%
    ...
    for (int monthc = 0; monthc < 12; monthc++) {
        ...
        if (monthc == 0) {
//            incomeAmount = monthlyBudgetAmount[0].janAmount;
//            expenseAmount = monthlyInvoiceAmount[0].janAmount;

        }
        else if (monthc == 1) {
//            incomeAmount = monthlyBudgetAmount[0].febAmount;
//            expenseAmount = monthlyInvoiceAmount[0].febAmount;

        }
        else if (monthc == 2) {
//            incomeAmount = monthlyBudgetAmount[0].marAmount;
//            expenseAmount = monthlyInvoiceAmount[0].marAmount;

        }
        else if (monthc == 3) {
//            incomeAmount = monthlyBudgetAmount[0].aprAmount;
//            expenseAmount = monthlyInvoiceAmount[0].aprAmount;

        }
        else if (monthc == 4) {
//            incomeAmount = monthlyBudgetAmount[0].mayAmount;
//            expenseAmount = monthlyInvoiceAmount[0].mayAmount;

        }
        else if (monthc == 5) {
//            incomeAmount = monthlyBudgetAmount[0].junAmount;
//            expenseAmount = monthlyInvoiceAmount[0].junAmount;

        }
        else if (monthc == 6) {
//            incomeAmount = monthlyBudgetAmount[0].julAmount;
//            expenseAmount = monthlyInvoiceAmount[0].julAmount;

        }
        else if (monthc == 7) {
//            incomeAmount = monthlyBudgetAmount[0].augAmount;
//            expenseAmount = monthlyInvoiceAmount[0].augAmount;

        }
        else if (monthc == 8) {
//            incomeAmount = monthlyBudgetAmount[0].sepAmount;
//            expenseAmount = monthlyInvoiceAmount[0].sepAmount;

        }
        else if (monthc == 9) {
//            incomeAmount = monthlyBudgetAmount[0].octAmount;
//            expenseAmount = monthlyInvoiceAmount[0].octAmount;

        }
        else if (monthc == 10) {
//            incomeAmount = monthlyBudgetAmount[0].novAmount;
//            expenseAmount = monthlyInvoiceAmount[0].novAmount;

        }
        else if (monthc == 11) {
//            incomeAmount = monthlyBudgetAmount[0].decAmount;
//            expenseAmount = monthlyInvoiceAmount[0].decAmount;
...
<div class="grpMonthlyAmount">
    <div class="monthlyBudAmt ${(loopmonth % 2) == 0 ? 'odd' : 'even'}">${incomeAmount}</div>

    <div class="monthlyInvAmt ${(loopmonth % 2) == 0 ? 'odd' : 'even'}">${ expenseAmount}</div>

    <div class="monthlyInvAmt ${(loopmonth % 2) == 0 ? 'odd' : 'even'}">${ taxReservation}</div>
