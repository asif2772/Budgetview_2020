...
//    def footerFirstLabel = [g.message(code: 'bv.dashboardDetails.forcast.label'),g.message(code: 'bv.dashboard.budget.label'),g.message(code: 'bv.dashboard.budget.label')]
...
//    def headerArr = ['Forecast And Booking','Income And Expense Budget','Income And Expense Invoice']
...
<%
    for (int v = 0; v < 3; v++) {
        ...
        if(v == 0){
            monthlyBudgetAmount = grossProfitForecastInstance;
