...
//            int budgetVendorId = Integer.parseInt(budgetVendorArr[v][0]);
            totalBudgetAmount = dashboardDetailsTagLib.getRoundedValue(budgetVendorArr[v][3]);
            totalInvoiceAmount = dashboardDetailsTagLib.getRoundedValue(budgetVendorArr[v][4]);
%>
