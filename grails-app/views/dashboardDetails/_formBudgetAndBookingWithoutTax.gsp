...
//    def footerFirstLabel = [g.message(code: 'bv.dashboard.budget.label'),g.message(code: 'bv.dashboardDetails.expense.label'),g.message(code: 'bv.dashboardDetails.expense.label')]
//    def footerLastLabel = [g.message(code: 'bv.dashboardDetails.booking.label'),g.message(code: 'bv.dashboardDetails.income.label'),g.message(code: 'bv.dashboardDetails.income.label')]
...
//    def chartToolTipBG = [g.message(code: 'bv.invoiceIncome.budgetAmount.label'),g.message(code: 'bv.menu.ExpenseBudget'),g.message(code: 'report.aging.expenseInvoice.label')]
//    def chartToolTipFG = [g.message(code: 'report.aging.invoiceAmount.label'),g.message(code: 'bv.menu.IncomeBudget'),g.message(code: 'invoiceIncomeDocuments.incomeInvoice.label')]
...
//    def headerArr1 = [g.message(code: 'bv.dashboard.totalBudgetAmount.label'),g.message(code: 'bv.dashboardDetails.totalExpenseBudget.label'),g.message(code: 'bv.dashboardDetails.totalExpenseInvoice.label')]
//    def headerArr2 = [g.message(code: 'bv.dashboard.totalInvoiceAmount.label'),g.message(code: 'bv.dashboardDetails.totalIncomeBudget.label'),g.message(code: 'bv.dashboardDetails.totalIncomeInvoice.label')]
...
<div id="accordion" style="height:1000px;background: none repeat scroll 0 0 #fcfcfc;">
<% for (int v = 0; v < 3; v++) {

    if(v == 0){
        monthlyBudgetAmount = netProfitInstance;
...
<div id="summary${v}" class="seeResultBodyHeader">
    <div id="list-page-body-inner" class="content" style="background-color: #fff; border: none; margin: 0">
        <div id="expense" style="padding: 0px; border-radius:none;">
            <div id="containerHC${v}" style="min-width: 150px; height: 300px; margin: 0 auto"></div>
<%
        /////////////////SKB----TOTAL SUM//////////////////
