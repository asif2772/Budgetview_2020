...
<%
    ...
    def budgetAccountCode = customerAHWArr[nTabInd][0];

//    println("budgetAccountCode "+budgetAccountCode);
//    println(customerAccountInstance);

    List<Map> monthlyBudgetAmount = dashboardDetailsTagLib.getMonthlyBudgetAmountAHWise(budgetAccountCode, customerAccountInstance);
    List<Map> monthlyInvoiceAmount = dashboardDetailsTagLib.getMonthlyInvoiceAmountAHWise(budgetAccountCode, customerInvoiceAccountInstance,true);
%>
    ...
    <%
        ...
        for (int monthc = 0; monthc < 12; monthc++) {
            ...
            if (monthc == 0) {
                ...
                budgetCustomerId = monthlyBudgetAmount[5].janVenCusId;
                ...
                budgetCustomerId = monthlyBudgetAmount[5].febVenCusId;
                ...
                budgetCustomerId = monthlyBudgetAmount[5].marVenCusId;
                ...
                budgetCustomerId = monthlyBudgetAmount[5].aprVenCusId;
                ...
                budgetCustomerId = monthlyBudgetAmount[5].mayVenCusId;
                ...
                budgetCustomerId = monthlyBudgetAmount[5].junVenCusId;
                ...
                budgetCustomerId = monthlyBudgetAmount[5].julVenCusId;
                ...
                budgetCustomerId = monthlyBudgetAmount[5].augVenCusId;
                ...
                budgetCustomerId = monthlyBudgetAmount[5].sepVenCusId;
                ...
                budgetCustomerId = monthlyBudgetAmount[5].octVenCusId;
                ...
                budgetCustomerId = monthlyBudgetAmount[5].novVenCusId;
    ...
    <div class="grpMonthlyAmount">
        <div class="monthlyBudAmt ${(loopmonth % 2) == 0 ? 'odd' : 'even'}">
            <% if(showCountBudget > 1){
                def multipleBudgetItemsURL = liveURL + '/dashboardIncomeList/invoice/'+ budgetCustomerId + '?g='+budgetAccountCode + '&m='+(monthc + 1)
            %>
            <a href="${multipleBudgetItemsURL}" target="_parent" title="Total Budget Item: ${showCountBudget}"  class="tooltip">
            <b> ${budgetAmount}</b><img width="10" height="10" alt="Add" src="${contextPath}/images/edit.png"></a></a>
            <% } else if(showCountBudget == 0){
                def budgetItemURL = liveURL + '/budgetItemIncomeDetails/list' + '?bookingPeriod='+bookingPeriod + '&customerId='+customerId
            %>
            ...
            <% } else if(showCountBudget == 1){
                def budgetIncomeURL = liveURL + '/budgetItemIncomeDetails/list' + '?editId=' + budgetItemId + '&bookingPeriod='+bookingPeriod + '&customerId='+budgetCustomerId + '&journalId='+budgetAccountCode
                def toolTipText = "Total Budget Item: " + showCountBudget +" \nCustomers: " + tempVenCusName;
            %>
            <a href="${budgetIncomeURL}" target="_parent" title=" ${toolTipText}" class="tooltip"><b> ${budgetAmount}</b>
            <img width="10" height="10" alt="Edit" src="${contextPath}/images/edit.png"></a></a>
            <% } %>
        </div>
        %{--Invoice income.--}%
        <div class="monthlyInvAmt ${(loopmonth % 2) == 0 ? 'odd' : 'even'}">
            <% def incomeInvoiceURL = liveURL + '/invoiceIncome/list' + '?bookInvoiceId=' + budgetItemId + '&bookingPeriod='+bookingPeriod + '&budgetCustomerId='+budgetCustomerId + '&customerId='+customerId+ '&budgetItemDetailsId='+budgetItemDetailsId %>
            <% if(showCountBudget > 0){
                if(invoiceAmount == 0){
            %>
            <a href="${incomeInvoiceURL}" target="_parent" title="Total Income Invoice: ${showCountBudgetInvoice}"
            ...
            <b>${invoiceAmount}</b><img width="10" height="10" alt="Add" src="${contextPath}/images/add.png"></a></a>
            <% }
            }%>
        </div>
    </div>
