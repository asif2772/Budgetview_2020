...
<%
    ...
    def footerLastLabel = [g.message(code: 'bv.dashboardDetails.forcast.label'),g.message(code: 'bv.dashboardDetails.forcast.label'),g.message(code: 'bv.dashboardDetails.forcast.label')]
//    def footerLastLabel = [g.message(code: 'bv.dashboardDetails.forcast.label'),g.message(code: 'bv.dashboardDetails.booking.label'),g.message(code: 'bv.dashboardDetails.booking.label')]
    ...
    def headerArr = [g.message(code: 'bv.dashboard.totalBudgetAndForecastSummary.label'),g.message(code: 'bv.dashboardDetails.incomeBudgetAndForcast.label'),g.message(code: 'bv.dashboardDetails.expenseBudgetAndForecast.label')]
//    def headerArr = [g.message(code: 'bv.dashboard.totalBudgetAndForecastSummary.label'),g.message(code: 'bv.dashboardDetails.incomeBudgetAndBooking.label'),g.message(code: 'bv.dashboardDetails.expenseBudgetAndBooking.label')]
...
<div class="footerAmount">
    ...
    %{--<div class="monthAmountLabel" style="margin-top: 18px;"><g:message code="bv.dashboardDetails.forcast.label" default="FORECAST" /> :</div>--}%
