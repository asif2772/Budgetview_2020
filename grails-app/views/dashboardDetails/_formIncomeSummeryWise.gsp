...
<%
    ...
    if (customerInstance.size()) {
        for (int v = 0; v < 2; v++) {
%>
<% if (v == 0) { %>
<h3><g:message code="dashBoard.regularCustomer.label" default="By Customer"/></h3>
<% } else if (v == 1) { %>
...
<div class="accountHead" style="width:27%">
    ...
    <div class="colTitle" style="text-align: left;">
        <g:message code="${message(code: 'bv.invoiceIncome.customerId.label', default: 'Customer Name')}"/>
    </div>
    <% } else if (v == 1) { %>
    <div class="colTitle" style="text-align: left;">
    ...
    <div class="budgetItemCol">
        <%
                loop = 1
                for (int i = 0; i < customerInstance.size(); i++) {
                    loop++
        %>
        <div class="accountHeadItem ${(loop % 2) == 0 ? 'even' : 'odd'}">${customerInstance[i][1]}</div>
        <%
                }
        %>
    </div>
...
<%
        ...
        def summaryTotalTempMonthCustomerId = "";
        ...
        for (int u = 0; u < customerInstance.size(); u++) {
            double summarytotalTempAmount = 0.0
            summaryTotalTempMonthCustomerId = customerInstance[u][0];

            customerAccountInstance.each {phnBudgetRootRegular ->
                phnBudgetRootRegular.each {phnBudgetRegular ->

                    if (phnBudgetRegular[0] == summaryTotalTempMonthCustomerId) {
            ...
            customerInvoiceAccountInstance.each {phnRootRegular ->

                if (phnRootRegular.size() > 0) {
                    phnRootRegular.each {phnRegular ->

                        //if (phnRegular[0] == Integer.parseInt(summaryTotalTempMonthCustomerId)) {
                        if (phnRegular[0] == summaryTotalTempMonthCustomerId) {
...
<%
        ...
        if (v == 0) {
            for (int g = 0; g < customerInstance.size(); g++) {
                ...
                def customerId = customerInstance[g][0]
                ...
                customerAccountInstance.each {phnBudgetRootRegular ->
                    ...
                    if (phnBudgetRootRegular.size() > 0) {
                        phnBudgetRootRegular.each {phnBudgetRegular ->
                            if (phnBudgetRegular[0] == customerId) {
                                if (phnBudgetRegular[3] == 1) {
                ...
                def tempMonthCustomerId = customerId
                ...
                customerInvoiceAccountInstance.each {phnRootRegular ->
                    ...
                    if (phnRootRegular.size() > 0) {
                        ...
                        phnRootRegular.each {phnRegular ->
                            ...
                            //if (phnRegular[0] == Integer.parseInt(tempMonthCustomerId)) {
                            if (phnRegular[0] == tempMonthCustomerId) {
                                if (Integer.parseInt(phnRegular[3]) == 1) {
...
<div class="budgetTotal">
    ...
    <div class="budgetItemCol">
        ...
        <%
                ...
                def totalTempMonthCustomerId = "";

                for (int k = 0; k < customerInstance.size(); k++) {


                    double totalTempAmount = 0.0
                    totalTempGlAccount = customerInstance[k][1];
                    totalTempMonthCustomerId = customerInstance[k][0];
                    //println("Id"+totalTempMonthCustomerId)

                    customerAccountInstance.each {phnBudgetRootRegular ->

                        if (phnBudgetRootRegular.size() > 0) {
                            phnBudgetRootRegular.each {phnBudgetRegular ->
                                if (phnBudgetRegular[0] == totalTempMonthCustomerId) {
                    ...
                    customerInvoiceAccountInstance.each {phnRootRegular ->
                        if (phnRootRegular.size() > 0) {
                            phnRootRegular.each {phnRegular ->
                                //if (phnRegular[0] == Integer.parseInt(totalTempMonthCustomerId)) {
                                if (phnRegular[0] == totalTempMonthCustomerId) {
...
<div class="budgetTotal">
    ...
    <div class="budgetItemCol">
        ...
        <%
                ...
                def accTotalTempMonthCustomerId = "";
                ...
                for (int k = 0; k < accountInstance.size(); k++) {
                    ...
                    accTotalTempMonthCustomerId = accountInstance[k][0];

                    accountAccountInstance.each {phnBudgetRoot ->
                        if (phnBudgetRoot.size() > 0) {
                            phnBudgetRoot.each {phnBudget ->
                                if (phnBudget[0] == accTotalTempMonthCustomerId) {
                    ...
                    accountInvoiceAccountInstance.each {phnRoot ->
                        if (phnRoot.size() > 0) {
                            phnRoot.each {phn ->
                                if (phn[0] == accTotalTempMonthCustomerId) {
