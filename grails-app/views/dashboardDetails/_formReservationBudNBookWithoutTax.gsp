...
<%
    ...
    def footerFirstLabel = [g.message(code: 'bv.dashboard.budget.label'),g.message(code: 'bv.dashboard.budget.label'),g.message(code: 'bv.dashboard.budget.label'),g.message(code: 'bv.dashboard.budget.label')]
    def footerLastLabel = [g.message(code: 'bv.dashboardDetails.booking.label'),g.message(code: 'bv.dashboardDetails.booking.label'),g.message(code: 'bv.dashboardDetails.booking.label'),g.message(code: 'bv.dashboardDetails.booking.label')]

    def barBGColor = ['rgba(120,120,120,1)','rgba(120,120,120,1)','rgba(120,120,120,1)','rgba(120,120,120,1)']

    def chartToolTipBG = [g.message(code: 'bv.invoiceIncome.budgetAmount.label'),g.message(code: 'bv.invoiceIncome.budgetAmount.label'),g.message(code: 'bv.invoiceIncome.budgetAmount.label'),g.message(code: 'bv.invoiceIncome.budgetAmount.label')]
    def chartToolTipFG = [g.message(code: 'report.aging.invoiceAmount.label'),g.message(code: 'report.aging.invoiceAmount.label'),g.message(code: 'report.aging.invoiceAmount.label'),g.message(code: 'report.aging.invoiceAmount.label')]
...
//    def headerArr = [g.message(code: 'bv.dashboardDetails.budgetAndBooking.label'),g.message(code: 'bv.dashboardDetails.incomeAndExpenseBudget.label'),g.message(code: 'bv.dashboardDetails.incomeAndExpenseInvoice.label')]
    def headerArr = [g.message(code: 'bv.dashboard.totalBudgetAndBookingSummary.label'),g.message(code: 'bv.dashboardDetails.incomeBudgetAndBooking.label'),g.message(code: 'bv.dashboardDetails.expenseBudgetAndBooking.label'),g.message(code: 'bv.dashboardDetails.reservationBudgetAndBooking.label')]

    def headerArr1 = [g.message(code: 'bv.dashboard.totalBudgetAmount.label'),g.message(code: 'bv.dashboard.totalBudgetAmount.label'),g.message(code: 'bv.dashboard.totalBudgetAmount.label'),g.message(code: 'bv.dashboard.totalBudgetAmount.label')]
    def headerArr2 = [g.message(code: 'bv.dashboard.totalInvoiceAmount.label'),g.message(code: 'bv.dashboard.totalInvoiceAmount.label'),g.message(code: 'bv.dashboard.totalInvoiceAmount.label'),g.message(code: 'bv.dashboard.totalInvoiceAmount.label')]
...
<% for (int v = 0; v < 4; v++) {
    ...
    if(v == 0){
        ...
        monthlyBudgetAmount = reservationBudgetInstance;
        monthlyBookingAmount = reservationInvoiceInstance;
    }
...
//    if(v== 3){
//         nTotalBudgetAmount = dashboardDetailsTagLib.getRoundedValue(monthlyBudgetAmount.allTotal)
//         nTotalBookingAmount = dashboardDetailsTagLib.getRoundedValue(monthlyBookingAmount.allTotal)
//    }else{
//       nTotalBudgetAmount = dashboardDetailsTagLib.getRoundedValue(monthlyBudgetAmount.allTotal)
//       nTotalBookingAmount = dashboardDetailsTagLib.getRoundedValue(monthlyBookingAmount.allTotal)
//    }
...
<div id="containerHC${v}" style="min-width: 150px; height: 250px; margin: 0 auto; align-items: 'left'"></div>
<%
        /////////////////SKB----TOTAL SUM//////////////////
        ...
        if(v == 3){
            janBookingAmount = janBookingAmount * (-1)
            febBookingAmount = febBookingAmount * (-1)
            marBookingAmount = marBookingAmount * (-1)
            aprBookingAmount = aprBookingAmount * (-1)
            mayBookingAmount = mayBookingAmount * (-1)
            junBookingAmount = junBookingAmount * (-1)
            julBookingAmount = julBookingAmount * (-1)
            augBookingAmount = augBookingAmount * (-1)
            sepBookingAmount = sepBookingAmount * (-1)
            octBookingAmount = octBookingAmount * (-1)
            novBookingAmount = novBookingAmount * (-1)
            decBookingAmount = decBookingAmount * (-1)
        }
