...
<body>
<a href="#show-dashboard" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="show-dashboard" class="content scaffold-show" role="main">
    ...
    <g:form>
        <fieldset class="buttons">
            ...
            <g:link class="edit" action="edit" id="${dashboardInstance?.id}"><g:message code="default.button.edit.label"
                                                                                        default="Edit"/></g:link>
