...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'DashboardListExpanseBudget.label', default: 'Expanse Budget Items(s)')}" />
    <title><g:message code="DashboardListExpanseBudget.label" default="Expanse Budget Items(s)" args="[entityName]" /></title>
</head>
<body>
    ...
    <div id="list-page">
        <div class="list-boxtitle">
            <div class="list-boxtitle-left">
                <g:message code="DashboardListExpanseBudget.invoice.list.label" default="Expanse Budget Item(s)" args="[entityName]" />
            </div>
            <div class="list-boxtitle-right">
                ...
                <g:form controller="budgetItemExpenseDetails" action="list" id="1">

                    <g:hiddenField name="order" value="${params.g}" />
                    <g:hiddenField name="vendorids" value="${params.id}" />
        ...
        <table>
            ...
            <g:each in="${invoiceListInstanceList}" status="i" var="invoiceListInstance">
                <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                    ...
                    <td>
                        <g:link controller="budgetItemExpenseDetails" action="listwisereport" id="${invoiceListInstance[0]}" ><g:img dir="images" file="view.png" width="15" height="16"  alt="View" /></g:link>&nbsp;
                        <g:link controller="budgetItemExpenseDetails" action="list" params="[sort: 'id', order: 'desc',editId: invoiceListInstance[0]]" ><g:img dir="images" file="edit.png" width="15" height="16"  alt="Edit" /></g:link>&nbsp;
                    </td>
                </tr>
            </g:each>
            </tbody>
