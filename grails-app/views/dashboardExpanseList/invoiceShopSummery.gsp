...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'DashboardListExpanseShppongSpend.label', default: 'Expanse Shopping Invoice(s)')}" />
    <title><g:message code="DashboardListExpanseShppongSpend.label" default="Expanse Shopping Invoice(s)" args="[entityName]" /></title>
</head>
<body>
    ...
    <div id="list-page">
        <div class="list-boxtitle">
            <div class="list-boxtitle-left">
                <g:message code="DashboardListExpanseShppongSpend.invoice.list.label" default="Expanse Shopping Invoice(s)" args="[entityName]" />
            </div>
