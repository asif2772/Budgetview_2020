...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'DashboardListSoppingSpend.label', default: 'Expanse Shopping Budget Items(s)')}" />
    <title><g:message code="DashboardListSoppingSpend.label" default="Expanse Shopping Budget Items(s)" args="[entityName]" /></title>
</head>
<body>
    ...
    <div id="list-page">
        <div class="list-boxtitle">
            <div class="list-boxtitle-left">
                <g:message code="DashboardListSoppingSpend.invoice.list.label" default="Expanse Shopping Budget Items(s)" args="[entityName]" />
            </div>
